...
| 未完成 / Pending | 第二台电脑 G8 安装与 Assist 验证 / G8 installation and Assist validation on a second computer |
| 平台 / Platform | Windows 11 x64 |

RC2 尚未达到稳定团队版标准。RC2 is not yet a completed stable team release.

## 下载 / Download

从 [GitHub Releases](https://github.com/RANJIANG23/CopilotBridge/releases/tag/v1.0.0-rc.2) 下载以下两个文件。Download both files from [GitHub Releases](https://github.com/RANJIANG23/CopilotBridge/releases/tag/v1.0.0-rc.2):
