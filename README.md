...
| 项目 / Item | 状态 / Status |
|---|---|
| 当前源码版本 / Current source version | `1.3.1-dev`（原生 WPF 微动效开发基线 / native WPF microinteraction development baseline） |
...
| 已通过 / Passed | Phase 0–29 and G1–G8；Phase 30 待开始 / Phase 30 not started |
