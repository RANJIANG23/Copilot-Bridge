...
| Phase 1 | Edge/CDP 功能探针 | 6–10 小时 | G1–G3 | 未开始 |
| Phase 2 | 最小业务核心 | 6–9 小时 | fixtures、发送边界、≤2500 LOC | 未开始 |
| Phase 3 | 薄 GUI 纵切 | 8–12 小时 | 非开发人员可完成首次使用 | 未开始 |
| Phase 4 | Codex MCP + Skill | 4–7 小时 | G4–G6 | 未开始 |
| Phase 5 | 完整三模式 | 7–11 小时 | 手动模式与会话隔离 | 未开始 |
| Phase 6 | 团队分发 | 6–10 小时 | G7–G8 | 未开始 |
| **总计** | **团队 v1** | **38–61 小时** | **全部门禁通过** | **未开始实现** |
