...
> 当前状态：v1.1.2 已发布；v1.2.0 Phase 15 已通过，Phase 16–19 尚未开始
...
| Phase 16 | 项目权限与本地查询核心 | 4–7 小时 | 默认关闭、分级授权、防泄漏与分页 | 未开始 |
| Phase 17 | 只读 MCP 与 Skill | 4–6 小时 | 四工具注解、STDIO、零 Edge 写入 | 未开始 |
| Phase 18 | Codex 项目感知纵切 | 3–5 小时 | 检索、读取、组织、咨询与留存闭环 | 未开始 |
| Phase 19 | v1.2.0 发布加固 | 3–5 小时 | 隔离升级、权限默认关闭、打包与回退 | 未开始 |
...
| Phase 16 | 未开始 | — | — | — | — | 等待 Phase 15 通过。 |
| Phase 17 | 未开始 | — | — | — | — | 等待 Phase 16 通过。 |
| Phase 18 | 未开始 | — | — | — | — | 等待 Phase 17 通过。 |
| Phase 19 | 未开始 | — | — | — | — | 等待 Phase 18 通过。 |
