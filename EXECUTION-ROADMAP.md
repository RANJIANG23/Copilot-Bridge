...
> 当前状态：v1.3.0 已发布；v1.3.1 Phase 29–31 已通过，Phase 32 待开始
...
| Phase 32 | 全屏连接保护纵切 | 3–5 小时 | 自动/MCP 冷连接零提示、零发送 | 未开始 |
| Phase 33 | v1.3.1 视觉与发布候选门禁 | 3–5 小时 | 双主题、全屏保护、隔离升级与打包 | 未开始 |
...
- 源码进入 `1.3.1-dev`；Plugin、发布脚本、下载说明和正式发布状态保持 1.3.0。
- 标准构建、既有测试、项目/依赖预算和 `.workbuddy/` 排除通过后创建本地提交。
