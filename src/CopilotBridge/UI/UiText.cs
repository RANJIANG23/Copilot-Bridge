...
internal static class UiText
{
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>
    {
        ...
        ["Bridge 管理的新即时对话会保留完整 Markdown；网页旧历史需在后续版本显式导入。"] = "New conversations managed by Bridge retain complete Markdown; existing web history requires an explicit future import.",
