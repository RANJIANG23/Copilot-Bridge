...
{
    [Fact]
    public void DevelopmentVersionIsSeparatedFromPublishedV121()
    {
        ...
        Assert.Contains("<Version>1.2.2-dev</Version>", File.ReadAllText(Path.Combine(root, "src", "CopilotBridge", "CopilotBridge.csproj")));
